...
- Environment's Templates category is a shared library across project scopes, not active instructions. Its editor reads and saves repository-root `templates/*.md`; no project deployment or automatic assistant injection. Keep template badges and save messaging distinct from active config files.
